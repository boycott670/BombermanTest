...
public class BombermanTest
{
  ...
  {
    Map map = new MapBuilder(3).addRock(1, 1) // line 1, column 1
  ...
  {
    Map map = new MapBuilder(3).addRock(1, 1)
        .build();
  ...
  {
    Map map = new MapBuilder(3).addRock(0, 1)
        .addRock(2, 1)
        .addRock(1, 2)
        .build();
    Bomberman bomber = new Bomberman("Hamid");
  ...
  {
    Map map = new MapBuilder(4).addRock(1, 1)
        .addStarRock(2, 3)
        .build();
    Bomberman bomber = new Bomberman("Hamid");
    bomber.startIn(map);
  ...
  public void aBombermanCanHaveEnhancerRocks()
  {
    int rangeEnhancer = 2;
    Map map = new MapBuilder(4).addRock(1, 1)
        .addEnhancerRock(2, 3, rangeEnhancer)
        .build();
    Bomberman bomber = new Bomberman("Hamid");
    bomber.startIn(map);
